...
const AZURE_SAS_TOKEN = process.env.AZURE_SAS_TOKEN || "sv=2024-11-04&ss=bfqt&srt=sco&sp=rwdlacupiytfx&se=2026-07-11T13:54:41Z&st=2025-07-11T05:54:41Z&spr=https,http&sig=zOrkXOq%2BeIaiddbFuoBbC%2B2T1dbSDTwxaOe6Gtfg%2Bto%3D";
...
exports.createAgent = async (req, res) => {
  ...
  const os = require('os');
  form.uploadDir = os.tmpdir(); // Cross-platform temporary directory
