            ...
            <Row className="g-3">
              <Col xs={12}>
                ...
                <Row className="pb-2 border-bottom mb-2" style={{ fontSize: '0.85rem', color: '#555' }}>
                  <Col xs="4"><strong>Serial:</strong> {item.serial || '01'}</Col>
                  <Col xs="4"><strong>Section:</strong> {item.section || '721'}</Col>
                  <Col xs="4"><strong>Part:</strong> {item.part || '1'}</Col>
                </Row>
                  ...
                  <Col md="4" sm="5">
                    ...
                    <div className="pt-2 mt-3 d-flex justify-content-between align-items-center">
                      <span>
                        ...
                        {item.age || 'N/A'} | {item.gender || 'Other'}
                      </span>
                    </div>
                  </Col>
                  <Col md="8" sm="7">
                    ...
                    <div className="fw-bold" style={{ fontSize: '0.9rem', lineHeight: '1.3', wordBreak: 'break-word', paddingBottom: "30px" }}>
                      {item.relatedPerson || 'N/A'}
                    </div>
                    <div className="small text-muted">Door No: {item.houseNumber || 'N/A'}</div>
                  </Col>
                </Row>
