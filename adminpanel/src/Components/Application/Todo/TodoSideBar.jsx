  ...
  return (
    <Col xl='3' className='xl-30 box-col-12'>
      <div className='md-sidebar'>
        <Btn attrBtn={{ onClick: (e) => setIsOpen(!isOpen), color: 'primary', className: 'md-sidebar-toggle' }}>Task filter</Btn>
                  ...
                  <div className='email-app-sidebar left-bookmark custom-scrollbar'>
                    <div className='d-flex align-items-center'>
                      <div className='media-size-email'>
                        <Image attrImage={{ className: 'me-3 img-40 rounded-circle', src: userImage, alt: '' }} />
                      </div>
