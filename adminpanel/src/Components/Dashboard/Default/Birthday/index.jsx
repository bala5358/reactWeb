...
import BirthdayCommon from "./BirthdayCommon";
import { FaFilter } from "react-icons/fa";

import BirthdayFilterModal from "./BirthdayFilterModal";
...
const Birthday = () => {
 ...
 const filteredData = voterData.filter((item) => {
  ...
  // ✅ DOB check for "DD/MM/YYYY"
  let matchesDobToday = false;
  if (item.dob) {
    const [day, month] = item.dob.split('/');
  ...
  return matchesSearch && matchesGender && matchesAge && matchesDobToday;
});
    ...
    <Fragment>
      ...
      <Container fluid={true}>
        <Row style={{ paddingBottom: "20px" }}>
          ...
          <Col sm="12">
            <BirthdayCommon data={filteredData} />
          </Col>
        </Row>
