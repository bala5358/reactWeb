        ...
        <Card className='hovercard text-center'>
          ...
          <div className='user-image'>
            <div className='avatar'>
              <Image attrImage={{ className: 'step1', alt: '', src: `${url ? url : require('../../../assets/images/user/profilelogo.jpg')}` }} />
            </div>
            ...
            <Row className='step3' data-intro='This is the your details'>
                ...
                <Row>
                  <Col md='6'>
                    <div className='ttl-info text-start'>
                      ...
                      <span>elections@rhythmvt.com</span>
                    </div>
                  </Col>
                  <Col md='6'>
              ...
              <Col sm='12' lg='4' className='order-sm-0 order-xl-1'>
                <div className='user-designation'>
                  ...
                  <div className='desc mt-2'>பேரூராட்சி தலைவர்</div>
                </div>
              </Col>
                ...
                <Row>
                  ...
                  <Col md='6'>
                    <div className='ttl-info text-start ttl-sm-mb-0'>
                      ...
                      <span>Election Tech Plaza, Suite 1200, San Francisco, CA 94105</span>
                    </div>
                  </Col>
                </Row>
              </Col>
