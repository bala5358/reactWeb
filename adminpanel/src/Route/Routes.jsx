...
export const routes = [
  ...
  {
    path: `/command-center/constituency/:constituencyId/:layout`,
  ...
  {
    path: `${process.env.PUBLIC_URL}/dashboard/default/birthday/:layout`,
    Component: <Birthday />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/default/Above80/:layout`,
    Component: <Above80 />,
  },
  {
    path: `${process.env.PUBLIC_URL}/dashboard/default/New/:layout`,
    Component: <New />,
  },
  {
...
{ path: `/candidate-nominations/:layout`, Component: <CandidateNominations /> },
  ...
  {
    path: `/clustersupervisor/:layout`,
    Component: <ClusterSupervisorDashboard />,
  },
  { path: `/clustersummary/boothlist/:layout`, Component: <BoothListTable /> },
  {
    path: `/clustersummary/submissionratespage/:layout`,
    Component: <SubmissionRatesPage />,
  },
  {
    path: `/clustersummary/agentactivitylogs/:layout`,
    Component: <AgentActivityLogs />,
  },
  {
    path: `/agentperformance/dailysubmissions/:layout`,
    Component: <DailySubmissions />,
  },
  {
    path: `/agentperformance/completionpercentage/:layout`,
  ...
  {
    path: `/issuefeed/resolveescalatelist/:layout`,
    Component: <ResolveEscalateList />,
  },
  {
    path: `/issuefeed/issuecommentstimeline/:layout`,
    Component: <IssueCommentsTimeline />,
  },

  //sathya

  {
    path: `/booth-agent/booth-overview/:layout`,
    Component: <MyBoothOverview />,
  },
  { path: `/booth-agent/voter-entry/:layout`, Component: <VoterDataEntry /> },
  { path: `/booth-agent/voters-turnout/:layout`, Component: <BoothTurnout /> },
  { path: `/booth-agent/field-notes/:layout`, Component: <BoothFieldNotes /> },
  {
    path: `/booth-agent/Voter-age-filter/:layout`,
    Component: <BoothLevelVoterAgeFilter />,
  },
  { path: `/booth-agent/voter-list/:layout`, Component: <Guardian /> },
  {
    path: `/booth-agent/voter-contact-info/:layout`,
    Component: <VoterContactInformation />,
  },
  {
    path: `/booth-agent/poll-day-operations/:layout`,
    Component: <PollDayOperation />,
  },
  {
    path: `/booth-agent/BoothTeam-Resource/:layout`,
    Component: <BoothTeamResource />,
  },
  ...
  {
    path: `/add/constitution-list/:layout`,
    Component: <AllConstitutionsTable />,
  },
  { path: `/add/clusteragent/:layout`, Component: <AddClusterAgents /> },
  {
    path: `/add/clusteragent-list/:layout`,
    Component: <AllClusterAgentsTable />,
  },
  { path: `/add/surveyagent/:layout`, Component: <AddSurveyAgent /> },
  {
    path: `/add/surveyagent-list/:layout`,
    Component: <AllSurveyAgentsTable />,
  },
  ...
  //bala
  {
    path: `/constituency-dashboard/:layout`,
  ...
  {
    path: `/forms/controls/votersurveyform/:layout`,
    Component: <VoterSurveyForm />,
  },
  ...
  { path: `/singanallurPoll/:layout`, Component: <SinganallurPoll /> },
  // //Knowledge
