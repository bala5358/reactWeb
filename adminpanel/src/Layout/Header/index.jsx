            ...
            <div className='form-group w-100'>
              <div className='Typeahead Typeahead--twitterUsers'>
                <div className='u-posRelative'>
                  <input className='Typeahead-input form-control-plaintext w-100' id='demo-input' type='search' placeholder='Search Rhythm ..' defaultValue={searchValue} onChange={(e) => handleSearchKeyword(e.target.value)} />
